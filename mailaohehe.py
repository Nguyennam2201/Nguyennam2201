...
while True:
    ...
    console.print("[bold blue]1.[/] Thay đổi e-mail")
    console.print("[bold blue]2.[/] Nhận mã")
    console.print("[bold blue]3.[/] Hiển thị các miền tùy chỉnh có sẵn")
    console.print("[bold blue]4.[/] Đặt tên miền email tùy chỉnh")
