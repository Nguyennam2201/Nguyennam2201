...
bug_duoc_cai_lon = {
    'pass': 'namprohehe' }
banner()
print('\x1b[1;34m_____________________________________________________________________________________')
import requests
import time
import re
from bs4 import BeautifulSoup
...
while True:
    console.print("\n[bold magenta]Tùy chọn:[/]")
    console.print("[bold blue]1.[/] ĐỔI MAIL")
    console.print("[bold blue]2.[/] NHẬN MÃ XÁC THỰC")
    console.print("[bold blue]3.[/] HIỂN THỊ CÁC MIỀN CÓ SẴN")
    console.print("[bold blue]4.[/] ĐẶT MIỀN MAIL TÙY CHỈNH")
    console.print("[bold blue]5.[/] EXIT")

    choice = Prompt.ask("[bold red]Nhập lựa chọn", choices=["1", "2", "3", "4", "5"], default="5")
